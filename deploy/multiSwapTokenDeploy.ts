...
const multiSwapTokenDeploy: DeployFunction = async ({ deployments, getNamedAccounts, network }) => {
  ...
  const multiSwapToken = await deploy('SwapMultihop', {
    from: deployer,
    args,
    log: true,
    waitConfirmations,
...
multiSwapTokenDeploy.tags = ['all', 'swapmultihop']
export default multiSwapTokenDeploy
